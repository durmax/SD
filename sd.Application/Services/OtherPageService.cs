...
public class OtherPageService : IOtherPageService
{
    ...
    public async Task<OtherPageModel> GetModelByAI(string exampleURL)
    {
        ...
        var prompt =
           ...
           $"Provide me new json of the new URL: {exampleURL}";
    ...
    x.Pattern == "www." + res.Pattern);
        ...
        res.PageType = "Dict";
        res.Eval = 0;
        res.Notes = new List<string> { "Generated by Gemini AI" };
        res.Notes = new List<string> { "Created by example URL: " + exampleURL };
